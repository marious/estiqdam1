...
<?php endif; ?>
            ...
            ?>
              ...
              <i class="fa fa-caret-<?= get_current_front_lang() == 'ar' ? 'left' : 'right' ?>" aria-hidden="true"></i>
<?php endif; ?>
                </a>
                <?php if (is_array($menu2['childs']) && count($menu2['childs'])): ?>
                <ul>
              ...
              ?>
                  ...
                  <li><a href="<?= site_url('page/'.Modules::run('pages/get_page_slug', $menu3['page'])) ?>"><?= $menu_lang_3 ?></a></li>
<?php endforeach; ?>
                </ul>
<?php endif; ?>
              </li>
