            ...
            <div class="box-header with-border bg-primary-dark">
                ...
                <div class="box-tools" style="padding-top: 5px">
                    <div class="input-group input-group-sm" >
                        <?php if (in_array('add_expense_category', $logged_in_user_permissions)): ?>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <?php if (in_array('edit_expense_category', $logged_in_user_permissions)): ?>
                                                <a data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal"
                                                   class="btn btn-xs btn-default" href="<?php echo base_url()?>transactions/add_expense_category/<?php echo $category->id?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <?php endif; ?>
                                                <?php if (in_array('delete_expense_category', $logged_in_user_permissions)): ?>
