            ...
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="col-md-5">
                        ...
                        <fieldset>
                            <legend><?= lang('new_deposit'); ?></legend>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-6 col-md-pull-2">
                                    <select name="category" id="category" class="form-control">
                                        <?php if (is_array($income_categories) && count($income_categories)): ?>
                        ...
                        <div class="">
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-bordered sys-table">
                                    ...
                                    <?php if (is_array($recent_deposits) && count($recent_deposits)): ?>
                                        <?php foreach ($recent_deposits as $recent_deposit): ?>
                                            <tr>
                                                <td><?= $this->transactions->get_account_name($recent_deposit) ?></td>
                                                <td class="amount"><?=$recent_deposit->amount?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
