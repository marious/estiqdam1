<form class="form-horizontal" action="<?= site_url('settings/add'); ?>" method="post">
                  ...
                  <!-- En Footer Copyright -->
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="form-control" id="en_footer_copyright" type="text" name="en_footer_copyright" value="<?= setting('') ?>">
										</div>
									</div>		
                    ...
                    <!-- AR Footer Copyright -->
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="form-control" id="ar_footer_copyright" type="text" name="ar_footer_copyright" value="<?= setting('') ?>">
										</div>
									</div>						
                  ...
                  <!-- EN Contact Addres  -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea class="form-control" name="en_contact_address" style="height:80px;" id="en_contact_address"><?= setting(''); ?>
                      </textarea>
										</div>
									</div>
                   ...
                   <!-- AR Contact Addres  -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea class="form-control" name="ar_contact_address" style="height:80px;" id="ar_contact_address"><?= setting(''); ?>
                      </textarea>
										</div>
									</div>
                  ...
                  <!-- Contact Email Address -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="contact_email" class="form-control" name="contact_email" value="<?= setting(''); ?>">
										</div>
									</div>
                  ...
                  <!-- Contact Phone Number -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="contact_phone" name="contact_phone" value="<?= setting(''); ?>">
										</div>
									</div>
                  ...
                  <!-- Contact Fax Number -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" id="contact_fax" class="form-control" name="contact_fax" value="<?= setting(''); ?>">
										</div>
									</div>
                  ...
                  <!-- Contact Map -->
									<div class="form-group">
										...
										<div class="col-sm-6">
											<textarea class="form-control" id="contact_map_iframe" name="contact_map_iframe" rows="5"><?= setting('') ?></textarea>
										</div>
									</div>
