<div id="app">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <a href="#" class="btn btn-primary" id="add_currency" @click="addModal = true"><i class="fa fa-plus"></i> <?= lang('new_tax'); ?></a>
        ...
        <div slot="body" class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="rate" name="rate" v-model="newTax.rate" autocomplete="off">
