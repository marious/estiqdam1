<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="<?= site_url('items/add_service/' . $id); ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="item_code" autocomplete="off" class="form-control" name="item_code"
                                   value="<?= set_value('item_code', $service->item_code) ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" id="sales_price" autocomplete="off" class="form-control" name="sales_price"
                                   value="<?= set_value('sales_price', $service->sales_price) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea name="description" id="description" rows="3" class="form-control"><?= set_value('description', $service->description) ?></textarea>
                        </div>
                    </div>
