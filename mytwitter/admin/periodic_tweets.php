...
<div class="col-md-12">
    <h2 class="page-header">Replies Tweets <div class="pull-right"><a href="" class="btn btn-primary new-tweet">New Replay Tweet</a></div></h2>
    ...
    <table class="table table-bordered">
        ...
        <?php $i = 1; foreach ($tweets as $tweet): ?>
                <?php $backgroundColor = '#FFF'; if ($tweet['status'] == 1) {$backgroundColor = '#CCC';} ?>
            <tr style="background-color: <?= $backgroundColor; ?>">
                <td><?= $i; ?></td>
                <td width="80%"><?= $tweet['tweet']; ?></td>
                <td>
                    <a href="" class="btn btn-sm btn-warning update-tweet" id="<?= $tweet['id'] ?>">Update</a>
                    <a href="<?= URL_ROOT . 'admin/tasks/delete_periodic_tweet.php?id=' . $tweet['id']; ?>" class="btn btn-sm btn-danger delete-btn">Delete</a>
                </td>
            </tr>
        <?php $i++; endforeach; ?>
        <?php endif; ?>
...
<!--                    <a href="--><?//= URL_ROOT . 'admin/tasks/delete_periodic.php?id=' . $task['id']; ?><!--" class="btn btn-danger btn-sm delete-btn">Delete</a>-->
<!--                </td>-->
<!--            </tr>-->
<!--        --><?php //$i++; endforeach; ?>
<!--        --><?php //endif; ?>
