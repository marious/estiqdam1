                            ...
                            <div class="form-group entry-style">
                                ...
                                <div class="col-md-6">
                                    ...
                                    $data = [
                                        ...
                                        'class'         => 'form-control',
                                        'id'            => 'contract_number',
                                        'value'         => set_value('contract_number', $contract_number)
                                    ];
                                    ?>
                                    <?= form_input($data); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group entry-style">
                                ...
                                <div class="col-md-6">
                                    ...
                                    ?>
                                    <?php
                                    echo form_dropdown('order_type', $order_types, set_value('order_type'), $data);
                                    ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group entry-style">
                                ...
                                <div class="col-md-8">
                                    ...
                                    ?>
                                    <?= form_dropdown('arrival_airport', $arrival_airports, set_value('arrival_airport'), $data); ?>
