                ...
                <div class="tab-content">
                    ...
                    <div class="form-horizontal entry-form">
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'value'         => set_value('worker_name_in_arabic', $services_worker->worker_name_in_arabic),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'value'         => set_value('worker_name_in_english', $services_worker->worker_name_in_english),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <?= form_dropdown('agent', $agents,
                                            set_value('agent', $services_worker->agent_id), $data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        <?= form_dropdown('departure_airport', $departure_airports, set_value('departure_airport', $services_worker->departure_airport_id), $data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'qualification',
                                            'value'         => set_value('qualification', $services_worker->qualification),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    <label for="worker_salary" class="control-label col-md-4">
                                        <?= lang('worker_salary'); ?>
                                    </label>
                                    <div class="col-md-8">
                                        <?php
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'worker_salary',
                                            'value'         => set_value('worker_salary', $services_worker->worker_salary),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        ?>
                                        <?= form_dropdown('worker_nationality', $worker_nationalities, set_value('worker_nationality', $worker_nationality->id), $data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        ?>
                                        <?= form_dropdown('visa_issued_city',$visa_issued_cities, set_value('visa_issued_city', $visa_issued_city->id), $data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        ?>
                                        <?= form_dropdown('worker_job', $worker_jobs, set_value('worker_job', $worker_job->id), $data); ?>
                            ...
                            <div class="col-md-3">
                            <div class="form-group entry-style">
                                <label for="passport_number" class="control-label col-md-4"><?= lang('passport_number'); ?></label>                                <div class="col-md-8">
                                    <?php
                                    $data = [
                                        'name'          => 'passport_number',
                                        'class'         => 'form-control',
                                        'id'            => 'passport_number',
                                        'value'         => set_value('passport_number', $services_worker->passport_number)
                                    ];
                                    ?>
                                    <?= form_input($data); ?>
