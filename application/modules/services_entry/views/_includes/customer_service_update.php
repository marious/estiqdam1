                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'value'         => set_value('customer_name_in_arabic', $services_customer->customer_name_in_arabic),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'value'         => set_value('customer_name_in_english', $services_customer->customer_name_in_english),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'customer_id',
                                            'value'         => set_value('customer_id', $services_customer->customer_id)
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <?= form_dropdown('customer_nationality', $customer_nationalities, set_value('customer_nationality', $customer_nationality->id), $data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'customer_mobile',
                                            'value'         => set_value('customer_mobile', $services_customer->customer_mobile),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'visa_number',
                                            'value'         => set_value('visa_number', $services_customer->visa_number),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'visa_date',
                                            'value'         => set_value('visa_date', $services_customer->visa_date),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
