                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'value'         => set_value('worker_name_in_english'),
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        <?= form_dropdown('departure_airport', $departure_airports, set_value('departure_airport'), $data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        ?>
                                        <?= form_dropdown('worker_nationality', $worker_nationalities, set_value('worker_nationality'), $data); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        ?>
                                        <?= form_dropdown('worker_job', $worker_jobs, set_value('worker_job'), $data); ?>
                                ...
                                <div class="form-group entry-style">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        $data = [
                                            ...
                                            'class'         => 'form-control',
                                            'id'            => 'passport_number',
                                            'value'         => set_value('passport_number')
                                        ];
                                        ?>
                                        <?= form_input($data); ?>
