                                    ...
                                    <?php foreach($p_list as $list){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="sc-col-3"><a class="mybtn btn-info btn-xs payee-edit-btn" href="<?php echo $list->trace_id ?>">Edit</a>
                                                <a class="mybtn btn-danger btn-xs payee-remove-btn"  href="<?php echo    site_url('acc_admin/payeeAndPayers/remove/'.$list->trace_id) ?>">Remove</a></td>
                                        </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add-payers-payee').on('submit',function(event){
            ...
            $.ajax({
                method : "POST",
                url : "<?php echo site_url('acc_admin/payeeAndPayers/insert') ?>",
                data : $(this).serialize(),
                beforeSend : function(){
...
//get table index
        ...
        function appendRow(id){
            var base='<?php echo base_url() ?>'+'acc_admin/payeeAndPayers/remove/'+id;
