                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="scroll-table-head table table-striped table-bordered">
                                <th class="sc-col-4">Account Name</th>
                                <th class="sc-col-3">Acc-Type</th>
                                <th class="sc-col-3">Action</th>
                            </table>
                            ...
                            <div class="scroll-div">
                                <table id="accounts-table" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <td class='sc-col-4 t_name'></td>
                                        <td class='sc-col-3 t_type'></td>
                                        <td class='sc-col-3'></td>
                                    </tr>
                                    <?php endif; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="sc-col-3">
                                            <a class="mybtn btn-info btn-xs chart-edit-btn"  href="<?php echo $list->chart_id ?>">Edit</a>
                                            <a class="mybtn btn-danger btn-xs chart-remove-btn"  href="<?php echo site_url('acc_admin/chartOfAccounts/remove/'.$list->chart_id) ?>">Remove</a>
                                    </tr>
                                    <?php  endforeach; ?>
                                </table>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add-Chart-account').on('submit',function(){
            $.ajax({
                method : "POST",
                url : "<?php echo site_url('acc_admin/chartOfAccounts/insert') ?>",
                data : $(this).serialize(),
                beforeSend : function(){
...
//get table index
        ...
        function appendRow(id){
            var base='<?php echo base_url() ?>'+'acc_admin/chartOfAccounts/remove/'+id;
