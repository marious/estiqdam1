                                ...
                                <?php foreach($p_list as $list){ ?>
                                    <tr>
                                        ...
                                        <td><a class="mybtn btn-info btn-xs method-edit-btn"  href="<?php echo $list->p_method_id ?>">Edit</a>
                                            <a class="mybtn btn-danger btn-xs method-remove-btn" href="<?php echo  site_url('acc_admin/paymentMethod/remove/'.$list->p_method_id) ?>">Remove</a></td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#add-payment-method').on('submit',function(){
            $.ajax({
                method : "POST",
                url : "<?php echo site_url('acc_admin/paymentMethod/insert') ?>",
                data : $(this).serialize(),
                beforeSend : function(){
...
//get table index
        ...
        function appendRow(id){
            var base='<?php echo base_url() ?>'+'acc_admin/paymentMethod/remove/'+id;
