                            ...
                            <div class="panel-body">
                                <div class="m-t">
                                    <ul class="users-types-tabs" id="users-types-tabs">
                                        <li><a href="<?= site_url('staff/add_user_staff'); ?>">User Staff</a></li>
                                        <li><a class="active" href="<?= site_url('staff/add_user_customer'); ?>">User Customer</a></li>
                                    ...
                                    <div class="tab-content users-form">
                                        <?php include 'includes/user_customer.php'; ?>
                                    </div>
