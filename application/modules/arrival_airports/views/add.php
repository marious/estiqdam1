        ...
        <div class="row">
            <div class="content">
                <div class="page-header">
                    <h3 class="page-title"> <?php echo (null == $id) ? lang('add_new') : lang('edit'); ?> <?= lang('arrival_airports'); ?></h3>
                </div>
                <!-- page header -->
                <div class="page-content-wrapper m-t">
                    <div class="block-content">
                        <ul class="nav nav-tabs">
                            <li class="">
                                <a href="<?= base_url() . 'arrival_airports'; ?>"><?= lang('arrival_airports'); ?></a>
                            </li>
                            <li class="<?php echo (null == $id) ? 'active' : ''; ?>">
                                <a href="<?php echo (null == $id) ? '' : site_url('arrival_airports/add'); ?>"><?= lang('add_new') ?></a>
                            </li>
